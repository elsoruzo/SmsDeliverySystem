...
namespace SmssApi.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(SmsDbContext SmssDbContext, ITokenService tokenService)
        {
        ...
        {
            var user = await SmssDbContext.Users.FindAsync(userId);
        ...
        {
            var user = SmssDbContext.Users.SingleOrDefault(user => user.Active && user.Email == loginRequest.Email);
        ...
        {
            var refreshToken = await SmssDbContext.RefreshTokens.FirstOrDefaultAsync(o => o.UserId == userId);
            ...
            SmssDbContext.RefreshTokens.Remove(refreshToken);
        ...
        {
            var existingUser = await SmssDbContext.Users.SingleOrDefaultAsync(user => user.Email == signupRequest.Email);
            ...
            await SmssDbContext.Users.AddAsync(user);
